...
class TRN(nn.Module):
    ...
    def __init__(self, img_feature_dim=1024, num_frames=args.train.num_clips, num_class=valid_labels, dropout=0.5):
        ...
        for i in range(len(self.scales)):
            ...
            classifier = nn.Linear(num_bottleneck, self.num_classes)
